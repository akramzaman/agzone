    ...
    <div class="contactUs" style="flex-grow: 1;">
        <div class="nav-bar" style="background-color: #2e7d32; padding: 10px 20px; max-width: 1200px; margin: 0 auto; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;">
            ...
            <div class="right-side" style="display: flex; align-items: center;">
                <ul id="nav-links" style="list-style: none; display: flex; gap: 20px; margin: 0; padding: 0;">
                    ...
                    <li><a href="contactUs.php" style="color: #f4b400; text-decoration: none; font-size: 16px;"><i class="fa fa-fw fa-user"></i> Login</a></li>
                    <li><a href="register.php" style="color: #fff; text-decoration: none; font-size: 16px;"><i class="fa fa-fw fa-user-plus"></i> Register</a></li>
                </ul>
            </div>
            ...
            <div class="mobile_nav" style="display: none; position: fixed; top: 0; right: 0; width: 250px; height: 100%; background-color: #2e7d32; padding: 20px; z-index: 1000;">
                <ul id="mobile_nav_links" style="list-style: none; padding: 0; margin: 0;">
                    ...
                    <li style="margin-bottom: 15px;"><a href="contactUs.php" style="color: #f4b400; text-decoration: none; font-size: 16px;"><i class="fa fa-fw fa-user"></i> Login</a></li>
                    <li style="margin-bottom: 15px;"><a href="register.php" style="color: #fff; text-decoration: none; font-size: 16px;"><i class="fa fa-fw fa-user-plus"></i> Register</a></li>
                </ul>
        ...
        <div class="contact_container" style="max-width: 1200px; margin: 20px auto; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
            <div class="heading" style="text-align: center; margin-bottom: 20px;">
                <p style="font-size: 28px; color: #2e7d32; margin: 0;">Login</p>
            </div>
            <div class="sub-para" style="text-align: center; margin-bottom: 20px;">
                <p style="font-size: 16px; color: #333; line-height: 1.6;">Please enter your credentials to access your AgZone account.</p>
            </div>
            <div class="form-container" style="max-width: 400px; margin: 0 auto;">
                <form action="login.php" method="post" style="display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <button type="submit" style="background-color: #2e7d32; color: #fff; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 16px; width: 100%; max-width: 200px; margin: 10px auto;">Login</button>
                </form>
                <p style="text-align: center; font-size: 14px; color: #333;">Don't have an account? <a href="register.php" style="color: #f4b400; text-decoration: none;">Register here</a>.</p>
            </div>
        </div>
    </div>
